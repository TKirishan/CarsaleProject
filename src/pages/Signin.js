...
import MyBackgroundImage from './range-rover.png';
        ...
        {/* <div className="body"> */}
            ...
            <div className="content">
                <div className="leftcontent">
                    ...
                    <button type="submit" id="btn1"><b>Create Accountn</b></button>

                    <button type="submit" id="btn2"><b>Next Step</b></button>
                    </form>
